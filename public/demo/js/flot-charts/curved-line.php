    ...
    var curvedLineChartData = [
   
        {
            ...
            data: [<?php
                 ...
                 $sql ="SELECT month(fecha_registro) AS fecha, count(iddenuncias) as id from denuncias where YEAR(fecha_registro) =YEAR(now()) group by month(fecha_registro) ";
                               $result = mysqli_query($conexion,$sql);  
                                
                               while ($registro = mysqli_fetch_array($result)) {
                                
                                ?>
                                       ['<?php echo $registro["fecha"] ?>','<?php echo $registro["id"] ?>'],
                                <?php
